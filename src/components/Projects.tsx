        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-16">
          {featuredProjects.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="group bg-black/50 border-white/10 overflow-hidden hover:border-amber-500/50 transition-all duration-500">
                ...
                <div className="p-6">
                  <h3 className="text-xl text-white mb-3 group-hover:text-amber-300 transition-colors duration-300">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-amber-400/20 text-amber-300 rounded-full text-sm border border-amber-400/40"
                      >
                        {tech}
                      </span>
                    ))}
          ...
          {otherProjects.map((project, index) => (
            ...
            >
              <Card className="group bg-black/30 border-white/10 hover:border-white/30 transition-all duration-300 h-full">
                ...
                <div className="p-4">
                  <h4 className="text-lg text-white mb-2 group-hover:text-amber-200 transition-colors duration-300">
                    {project.title}
                  </h4>
